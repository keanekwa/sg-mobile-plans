          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={4}>
              <TextField
                ...
                label="Data"
                defaultValue={
                  props.options.minData !== 0 && props.options.minData
                }
                fullWidth={true}
            ...
            <Grid item xs={12} sm={4}>
              <TextField
                ...
                label="Talktime"
                defaultValue={
                  props.options.minTalktime !== 0 && props.options.minTalktime
                }
                fullWidth={true}
            ...
            <Grid item xs={12} sm={4}>
              <TextField
                ...
                label="SMS"
                defaultValue={
                  props.options.minSMS !== 0 && props.options.minSMS
                }
                fullWidth={true}
                  ...
                  {props.options.planTypes.map(planType => {
                    return (
                      <FormControlLabel
                        ...
                        control={
                          <Checkbox
                            defaultChecked={planType.isChecked}
                            value={planType.value}
                            onChange={event => handleChange(event, 'planTypes')}
                          />
                        }
                  ...
                  {props.options.telcos.map(telco => {
                    return (
                      <FormControlLabel
                        ...
                        control={
                          <Checkbox
                            defaultChecked={telco.isChecked}
                            value={telco.value}
                            onChange={event => handleChange(event, 'telcos')}
                          />
                        }
                        label={telco.value}
                      />
            ...
            <Grid item xs={12}>
              <Button
                ...
                onClick={() => props.setIsShowResults(true)}
                variant="contained"
                size="large"
                color="primary"
              >
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withStyles(styles)(SelectSelfOptions));
